	...
	public static void main(String[] args) {
	   ...
	   // to find the element
		...
		if(driver.getTitle().contains("View Lead")){
			...
			elementclearCompanyname.sendKeys("jutebage");
			
			WebElement elementClearFirstname = driver.findElement(By.id("createLeadForm_firstName"));
			elementClearFirstname.clear();
			elementClearFirstname.sendKeys("white");
			
			WebElement elementClearLastname = driver.findElement(By.id("createLeadForm_lastName"));
			elementClearLastname.clear();
			elementClearLastname.sendKeys("Black");
			
			WebElement elementNewCreate = driver.findElement(By.className("smallSubmit"));
			elementNewCreate.click();
